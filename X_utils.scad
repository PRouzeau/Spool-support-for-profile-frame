...
module BB (type="623", side=1) {
  ...
  if (type=="602") B(7,2,3.5, 0.7,8.5,side,flanged);   
  else if (refBB=="F602") B(7,2,2.8, 0.7,8.5,side,flanged);   
  else if (type=="602X")B(8,2.5,4, 0.7,9.5, side,flanged);                 
  else if (refBB=="F602X")B(8,2.5,2.8, 0.7,9.5, side,flanged);   
  else if (type=="603") B(9,3,4, 0.7,10.5, side,flanged);     
